...
```bash
git clone git@github.com:ghostwriter/empty-vs-strict-benchmark.git
cd empty-vs-strict-benchmark
git remote add upstream git://github.com/ghostwriter/empty-vs-strict-benchmark.git
```
